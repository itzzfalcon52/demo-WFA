    ...
    <div className="rounded-2xl p-6 bg-gradient-to-r from-purple-500 to-pink-500 shadow-lg hover:scale-105 transition-all">
      ...
      <ul className="space-y-2 text-white">
        <li className="flex justify-between">
          ...
          <span className="font-bold">{metrics.requests_total || 0}</span>
        </li>
        <li className="flex justify-between">
          <span className="text-gray-200">Alerts Blocked</span>
          <span className="font-bold">{metrics.alerts_blocked || 0}</span>
        </li>
        <li className="flex justify-between">
        ...
        <li className="flex justify-between">
          <span className="text-gray-200">Avg ML Score</span>
          <span className="font-bold">
            {metrics.ml_score_avg
              ? (metrics.ml_score_avg * 100).toFixed(1) + "%"
              : "0%"}
          </span>
        </li>
        <li className="flex justify-between">
